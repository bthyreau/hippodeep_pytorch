...
which should take care of downloading the dependencies in the first run (or run 'uv sync' in the repo). 

You can optionally call the deepseg1.sh script, or symlink it from anywhere in your $PATH
